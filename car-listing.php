...
$sql = "SELECT v.*, b.brand_name FROM vehicles v LEFT JOIN brands b ON v.brand_id = b.id WHERE v.availability = 1";
            ...
            ?>
                <div class="car-item">
                    ...
                    <div class="car-details">
                        ...
                        <a href="view-details.php?id=<?php echo htmlspecialchars($row['id']);?>" class="view-details">View Details</a>
                    </div>
                </div>
            <?php
                }
...
<div class="pagination">
    <?php if ($page > 1): ?>
        <a href="?page=<?php echo $page - 1; ?>&brand=<?php echo urlencode($_GET['brand'] ?? ''); ?>&fuel_type=<?php echo urlencode($_GET['fuel_type'] ?? ''); ?>&car_name=<?php echo urlencode($_GET['car_name'] ?? ''); ?>&year=<?php echo urlencode($_GET['year'] ?? ''); ?>&min_price=<?php echo urlencode($_GET['min_price'] ?? ''); ?>&max_price=<?php echo urlencode($_GET['max_price'] ?? ''); ?>" class="prev">Previous</a>
    <?php endif; ?>
    
    <span>Page <?php echo $page; ?> of <?php echo $totalPages; ?></span>
    
    <?php if ($page < $totalPages): ?>
        <a href="?page=<?php echo $page + 1; ?>&brand=<?php echo urlencode($_GET['brand'] ?? ''); ?>&fuel_type=<?php echo urlencode($_GET['fuel_type'] ?? ''); ?>&car_name=<?php echo urlencode($_GET['car_name'] ?? ''); ?>&year=<?php echo urlencode($_GET['year'] ?? ''); ?>&min_price=<?php echo urlencode($_GET['min_price'] ?? ''); ?>&max_price=<?php echo urlencode($_GET['max_price'] ?? ''); ?>" class="next">Next</a>
    <?php endif; ?>
</div>
